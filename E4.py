#Utilizando o dicionário de alunos em anexo faça um programa que remova um
#nome do dicionário(você que escolhe).
...
remover = (input("Digite um nome para remover:")).upper()
del Alunos[remover]
print(Alunos)
